...
struct _TLIBC_ABSTRACT_WRITER
{
	...
	TLIBC_ERROR_CODE (*write_vector_element_begin)(TLIBC_ABSTRACT_WRITER *self, const char *var_name, tuint32 index);
	TLIBC_ERROR_CODE (*write_vector_element_end)(TLIBC_ABSTRACT_WRITER *self, const char *var_name, tuint32 index);
...
TLIBC_API TLIBC_ERROR_CODE tlibc_write_vector_element_begin(TLIBC_ABSTRACT_WRITER *self, const char *var_name, tuint32 index);
TLIBC_API TLIBC_ERROR_CODE tlibc_write_vector_element_end(TLIBC_ABSTRACT_WRITER *self, const char *var_name, tuint32 index);
